package cn.solarmoon.spark_core.api.animation.anim.helper
    ...
    companion object {
        ...
        val CODEC: Codec<KeyFrame> = RecordCodecBuilder.create {
            it.group(
                ...
                VECTOR3F_CODEC.fieldOf("value").forGetter { it.targetPre },
                VECTOR3F_CODEC.fieldOf("value").forGetter { it.targetPost },
