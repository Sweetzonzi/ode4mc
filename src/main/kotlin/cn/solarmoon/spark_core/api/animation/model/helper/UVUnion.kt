...
import cn.solarmoon.spark_core.api.animation.model.helper.UVUnion.FaceUV
...
data class UVUnion(
    ...
    companion object {
        ...
        @JvmStatic
        val STREAM_CODEC = object : StreamCodec<RegistryFriendlyByteBuf, UVUnion> {
            override fun decode(buffer: RegistryFriendlyByteBuf): UVUnion {
            ...
            override fun encode(buffer: RegistryFriendlyByteBuf, value: UVUnion) {
