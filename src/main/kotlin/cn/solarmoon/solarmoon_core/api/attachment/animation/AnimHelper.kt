...
import cn.solarmoon.solarmoon_core.api.renderer.TextureRenderHelper
...
object AnimHelper {
    ...
    object Fluid {
        ...
        fun createFluidAnim(be: BlockEntity) {
            val anim: AnimTicker = be.getData(CommonAttachments.ANIMTICKER)
            val timer = Timer()
            timer.maxTime = 10f
        ...
        fun startFluidAnim(be: BlockEntity, fluidStack: FluidStack) {
            val anim = be.getData(CommonAttachments.ANIMTICKER)
