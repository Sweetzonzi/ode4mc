...
import cn.solarmoon.spark_core.api.phys.ode.DBody;
import cn.solarmoon.spark_core.api.phys.ode.DJoint;
import cn.solarmoon.spark_core.api.phys.ode.DRotation;
import cn.solarmoon.spark_core.api.phys.ode.internal.DObject;
import cn.solarmoon.spark_core.api.phys.ode.internal.DxBody;
...
//		addObjectToList( this, ( dObject ** ) &w.firstjoint );
	...
	void setFixedOrientation(DxJoint joint, double fps, double erp, int rowskip, double[] J1A, int J1Ofs, double[] J2A
		...
		if ( b1 != null)
		{
			...
			DRotation.dQMultiply1( qq, b0._q, b1._q );
			DRotation.dQMultiply2( qerr, qq, qrel );
		}
		else
		{
			DRotation.dQMultiply3( qerr, b0._q, qrel );
		}
		if ( qerr.get0() < 0)
		{
...
//			result.v[2] = axis2.v[2];
			...
			DQuaternion q_initial )
	{
		...
		{
			DQuaternion qq = new DQuaternion();
			DRotation.dQMultiply1( qq, body1._q, body2._q );
			DRotation.dQMultiply2( qrel, qq, q_initial );
		}
		else
		{
			// pretend body2.q is the identity
			DRotation.dQMultiply3( qrel, body1._q, q_initial );
		}
