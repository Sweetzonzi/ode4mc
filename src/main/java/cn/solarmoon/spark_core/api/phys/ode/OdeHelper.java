 ...
 *                                                                       *
 *************************************************************************/
package cn.solarmoon.spark_core.api.phys.ode;

import cn.solarmoon.spark_core.api.phys.math.DVector3;
import cn.solarmoon.spark_core.api.phys.math.DVector3C;
import cn.solarmoon.spark_core.api.phys.ode.DGeom.DNearCallback;
import cn.solarmoon.spark_core.api.phys.ode.DTriMesh.DTriCallback;
import cn.solarmoon.spark_core.api.phys.ode.DTriMesh.DTriRayCallback;
import cn.solarmoon.spark_core.api.phys.ode.internal.*;
import cn.solarmoon.spark_core.api.phys.ode.internal.joints.DxJointConstrainedBall;
import cn.solarmoon.spark_core.api.phys.ode.internal.joints.DxJointGroup;
import cn.solarmoon.spark_core.api.phys.ode.internal.joints.OdeJointsFactoryImpl;
import cn.solarmoon.spark_core.api.phys.ode.internal.ragdoll.DxRagdoll;
import cn.solarmoon.spark_core.api.phys.ode.internal.trimesh.DxTriMesh;
import cn.solarmoon.spark_core.api.phys.ode.internal.trimesh.DxTriMeshData;
import cn.solarmoon.spark_core.api.phys.ode.ragdoll.DRagdoll;
import cn.solarmoon.spark_core.api.phys.ode.ragdoll.DRagdollConfig;
...
//	}
	...
	public static DTriMesh createTriMesh(DSpace space, DTriMeshData data, DTriCallback callback,
                                         cn.solarmoon.spark_core.api.phys.ode.DTriMesh.DTriArrayCallback arrayCallback,
                                         DTriRayCallback rayCallback) {
