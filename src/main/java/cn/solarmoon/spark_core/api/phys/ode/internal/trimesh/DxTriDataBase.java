 ...
 *                                                                       *
 *************************************************************************/
package cn.solarmoon.spark_core.api.phys.ode.internal.trimesh;

import cn.solarmoon.spark_core.api.phys.math.DVector3;
import cn.solarmoon.spark_core.api.phys.math.DVector3C;
import cn.solarmoon.spark_core.api.phys.ode.DTriMeshData;
import cn.solarmoon.spark_core.api.phys.ode.internal.*;
...
import cn.solarmoon.spark_core.api.phys.ode.ou.CEnumUnsortedElementArray;

import static cn.solarmoon.spark_core.api.phys.ode.DTriMesh.*;
import static cn.solarmoon.spark_core.api.phys.ode.DTriMesh.dMESHDATAUSE.*;
import static cn.solarmoon.spark_core.api.phys.ode.DTriMeshData.dTRIDATAPREPROCESS_FACE_ANGLES_EXTRA__MAX;
import static cn.solarmoon.spark_core.api.phys.ode.DTriMeshData.dTRIDATAPREPROCESS_FACE_ANGLES_EXTRA__MIN;
import static cn.solarmoon.spark_core.api.phys.ode.OdeMath.*;
import static cn.solarmoon.spark_core.api.phys.ode.internal.Common.M_PI;
import static cn.solarmoon.spark_core.api.phys.ode.internal.Common.M_PI_2;
...
//            final EdgeRecord currEdge1 = edges[currEdgeOfs + 1];
    ...
    //    {
    //    &FaceAnglesWrapper<cn.solarmoon.spark_core.api.phys.ode.internal.trimesh.FaceAngleStorageCodec<uint8, SSI_SIGNED_STORED>>::allocateInstance, // ASM_BYTE_SIGNED,
    //    &FaceAnglesWrapper<cn.solarmoon.spark_core.api.phys.ode.internal.trimesh.FaceAngleStorageCodec<uint8, SSI_POSITIVE_STORED>>::allocateInstance, // ASM_BYTE_POSITIVE,
    //    &FaceAnglesWrapper<cn.solarmoon.spark_core.api.phys.ode.internal.trimesh.FaceAngleStorageCodec<uint16, SSI_SIGNED_STORED>>::allocateInstance, // ASM_WORD_SIGNED,
    //    };
    //    END_NAMESPACE_OU();
