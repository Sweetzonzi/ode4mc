...
import cn.solarmoon.spark_core.api.phys.math.DMatrix3;
import cn.solarmoon.spark_core.api.phys.math.DVector3;
import cn.solarmoon.spark_core.api.phys.ode.DJoint;
import cn.solarmoon.spark_core.api.phys.ode.DRotation;
import cn.solarmoon.spark_core.api.phys.ode.internal.Objects_H.dxQuickStepParameters;
import cn.solarmoon.spark_core.api.phys.ode.internal.cpp4j.FILE;
import cn.solarmoon.spark_core.api.phys.ode.internal.joints.DxJoint;
import cn.solarmoon.spark_core.api.phys.ode.internal.processmem.DxStepperProcessingCallContext;
import cn.solarmoon.spark_core.api.phys.ode.internal.processmem.DxStepperProcessingCallContext.dmaxcallcountestimate_fn_t;
import cn.solarmoon.spark_core.api.phys.ode.internal.processmem.DxStepperProcessingCallContext.dstepper_fn_t;
import cn.solarmoon.spark_core.api.phys.ode.internal.processmem.DxUtil.BlockPointer;
import cn.solarmoon.spark_core.api.phys.ode.internal.processmem.DxWorldProcessIslandsInfo.dmemestimate_fn_t;
import cn.solarmoon.spark_core.api.phys.ode.internal.processmem.DxWorldProcessMemArena;
import cn.solarmoon.spark_core.api.phys.ode.threading.Atomics;
import cn.solarmoon.spark_core.api.phys.ode.threading.task.Task;
import cn.solarmoon.spark_core.api.phys.ode.threading.task.TaskGroup;

import java.io.PrintStream;
import java.util.Arrays;
import java.util.concurrent.atomic.AtomicInteger;

import static cn.solarmoon.spark_core.api.phys.ode.DMatrix.dSetValue;
import static cn.solarmoon.spark_core.api.phys.ode.OdeConstants.dInfinity;
import static cn.solarmoon.spark_core.api.phys.ode.OdeMath.*;
import static cn.solarmoon.spark_core.api.phys.ode.internal.Common.*;
import static cn.solarmoon.spark_core.api.phys.ode.internal.CommonEnums.*;
import static cn.solarmoon.spark_core.api.phys.ode.internal.Matrix.dSetZero;
import static cn.solarmoon.spark_core.api.phys.ode.internal.Misc.dRandInt;
import static cn.solarmoon.spark_core.api.phys.ode.internal.QuickStepEnums.*;
import static cn.solarmoon.spark_core.api.phys.ode.internal.Timer.*;
import static cn.solarmoon.spark_core.api.phys.ode.internal.Timer.dTimerReport;
import static cn.solarmoon.spark_core.api.phys.ode.internal.cpp4j.Cstring.memcpy;
	        ...
	        while ((ji = Atomics.ThrsafeIncrementIntUpToLimit(stage2CallContext.m_ji_J, nj)) != nj) {
	            ...
	            int jRow = ofsi * JME__MAX;
				{
					...
					for (int jCurr = jRow; jCurr != jEnd; jCurr += JME__MAX) {
						DRotation.dSetZero(J, jCurr + JME__J1_MIN, JME__J1_COUNT);
						J[jCurr + JME_RHS] = 0.0;
						J[jCurr + JME_CFM] = worldCFM;
						DRotation.dSetZero(J, jCurr + JME__J2_MIN, JME__J2_COUNT);
...
//					}
    ...
    void dxQuickStepIsland_Stage4a(dxQuickStepperStage4CallContext stage4CallContext)
    {
        ...
        while ((ji_step = Atomics.ThrsafeIncrementIntUpToLimit(stage4CallContext.m_ji_4a, nj_steps)) != nj_steps) {
			...
			DRotation.dSetZero(lambda, lambdacurr, lambdsnext - lambdacurr);
        }
    }
    ...
    void dxQuickStepIsland_Stage4LCP_MTfcComputation_cold(dxQuickStepperStage4CallContext stage4CallContext)
    {
        ...
        while ((bi_step = Atomics.ThrsafeIncrementIntUpToLimit(stage4CallContext.m_mi_fc, nb_steps)) != nb_steps) {
			...
			DRotation.dSetZero(fc, bi * CFE__MAX, bicnt * CFE__MAX);
        }
    }
