 ...
 *                                                                       *
 *************************************************************************/
package cn.solarmoon.spark_core.api.phys.ode.internal.joints;
...
import cn.solarmoon.spark_core.api.phys.ode.DUniversalJoint;
import cn.solarmoon.spark_core.api.phys.ode.internal.DxWorld;
...
import static cn.solarmoon.spark_core.api.phys.ode.internal.Common.dRecip;
import static cn.solarmoon.spark_core.api.phys.ode.internal.Rotation.dRFrom2Axes;
...
public class DxJointUniversal extends DxJoint implements DUniversalJoint {
    ...
    getAngles(RefDouble angle1, RefDouble angle2) {
        if (node[0].body != null) {
            ...
            DRotation.dQMultiply1(qq, node[0].body._q, qcross);
            DRotation.dQMultiply2(qrel, qq, qrel1);
            ...
            DRotation.dQMultiply0(qcross2, qrel, qcross);

            if (node[1].body != null) {
                DRotation.dQMultiply1(qq, node[1].body._q, qcross2);
                DRotation.dQMultiply2(qrel, qq, qrel2);
            } else {
                // pretend joint->node[1].body->q is the identity
                DRotation.dQMultiply2(qrel, qcross2, qrel2);
            }
    ...
    protected double getAngle2Internal() {
        if (node[0].body != null) {
            ...
            if (node[1].body != null) {
                DRotation.dQMultiply1(qq, node[1].body._q, qcross);
                DRotation.dQMultiply2(qrel, qq, qrel2);
            } else {
                // pretend joint->node[1].body->q is the identity
                DRotation.dQMultiply2(qrel, qcross, qrel2);
            }
    ...
    void computeInitialRelativeRotations() {
        if (node[0].body != null) {
            ...
            dRFrom2Axes(R, ax1, ax2);
            DRotation.dQfromR(qcross, R);
            DRotation.dQMultiply1(qrel1, node[0].body._q, qcross);

            // Axis 2.
            dRFrom2Axes(R, ax2, ax1);
            DRotation.dQfromR(qcross, R);
            if (node[1].body != null) {
                DRotation.dQMultiply1(qrel2, node[1].body._q, qcross);
            } else {
